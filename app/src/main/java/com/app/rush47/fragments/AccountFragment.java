...
public class AccountFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setupRow(view, R.id.rowMyRewards, R.drawable.myreward_icon, R.string.my_reward,
                () -> startActivity(new Intent(getContext(), MyRewardedActivity.class)));
    ...
    public void onResume() {
        super.onResume();
        if (getView() != null) {
            fetchCoinBalance(getView()); // balance may have changed on another tab
        }
    }
    ...
    // ---------------------------------------------------------------
    // Customer Support - static contact info page.
    // ---------------------------------------------------------------
