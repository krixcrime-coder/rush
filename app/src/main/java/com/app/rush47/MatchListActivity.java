...
/**
 * Shown when you tap a category card on the Play page (e.g. "FULL MAP").
 * Header matches the original app: back arrow, game/category title, and
 * a wallet-balance chip. Below it, three tabs - Ongoing / Upcoming /
 * Completed - each backed by its own MatchStatusFragment page so the
 ...
 *
 * Launch with EXTRA_GAME_ID (required unless EXTRA_CATEGORY_ID is set),
 * EXTRA_CATEGORY_ID (preferred - shows only this category's matches),
 * EXTRA_TITLE (shown in the header) and EXTRA_TYPE ("tournament" or
 * "solo" - which category type this list was opened from).
 */
public class MatchListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new MatchStatusPagerAdapter(getSupportFragmentManager(), gameId, categoryId, type));
