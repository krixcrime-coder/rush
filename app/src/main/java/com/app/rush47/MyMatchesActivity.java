        ...
        recyclerView.setAdapter(new TournamentAdapter(tournaments, false, new TournamentAdapter.OnTournamentClickListener() {
            ...
            public void onCardClick(Tournament tournament) {
                if (tournament.isCompleted()) {
                    Intent intent = new Intent(MyMatchesActivity.this, MatchResultActivity.class);
                    intent.putExtra(MatchResultActivity.EXTRA_MATCH_ID, tournament.getTournamentId());
                    intent.putExtra(MatchResultActivity.EXTRA_MATCH_NAME, tournament.getTitle());
                    intent.putExtra(MatchResultActivity.EXTRA_BANNER_URL, tournament.getImageUrl());
